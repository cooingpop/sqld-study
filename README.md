...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>서브쿼리의 실행 결과가 여러 건인 서브쿼리를 의미한다.<br />다중행 서브쿼리는 다중 행 비교 연산자와 함께 사용된다.<br />다중 행 비교 연산자에는 IN, ALL, ANY, SOME, EXISTS가 있다.</td>
        </tr>
        <tr>
...
###### 서브쿼리의 결과가 복수행 결과를 반환하는 경우네느 IN, ALL, ANY등으 ㅣ복수 행 비교 연산자와 사용하여야 한다.
